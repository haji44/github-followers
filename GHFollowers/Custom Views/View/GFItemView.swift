...
// This class plays a role creating item of view
class GFItemView: UIView {
    ...
    // This method used to set the UI
    func configure() {
        ...
        NSLayoutConstraint.activate([
            ...
            titleLabel.topAnchor.constraint(equalTo: symbolImageView.bottomAnchor, constant: 4),
    ...
    // This method find out what type of item should set
    // and then add the number of those items
    func set(itemInfoType: ItemInfoType, withCount count: Int) {
        switch itemInfoType {
        case .repo:
            symbolImageView.image = UIImage(systemName: SFSymbol.folder)
